...
<p align="center">
<img src="TIL_img/22.01.23(Thread)/newThreadCallStartMethod.jpg" width="80%">
</p>
...
<p align="center">
<img src="TIL_img/22.01.23(Thread)/SingleThreadMultiThread.jpg" width="50%">
</p>
...
- **싱글쓰레드와 멀티쓰레드의 비교**
<p align="center">
<img src="TIL_img/22.01.23(Thread)/SingleThreadMultiThread2.jpg" width="50%">
</p>
...
<p align="center">
<img src="TIL_img/22.01.23(Thread)/ThreadGroupMethod.jpg" width="70%">
</p>
...
- **쓰레드의 스케줄링 메서드**
<p align="center">
<img src="TIL_img/22.01.23(Thread)/ThreadSchedulingMothod.jpg" width="70%">
</p>
...
<p align="center">
<img src="TIL_img/22.01.23(Thread)/ThreadState.jpg" width="80%">
</p>
...
실행결과
<p>
<img src="TIL_img/22.01.23(Thread)/ThreadEx13Result.jpg" width="30%">
</p>
...
### **suspend(), resume(), stop()**
이 메서드 들은 쓰레드의 실행을 제어하는 가장 손쉬운 방법이지만, 교착상태(deadlock)을 일으키기 쉽게 작성이되어있으므로 사용이 권장되지 않는다. 'deprecated'되어있다.
